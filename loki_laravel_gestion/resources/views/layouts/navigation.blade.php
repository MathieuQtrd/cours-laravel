            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->check()) {{-- Si l'utilisateur est connecté --}}
                        {{--
                        auth()->check() => vérifie si l'utilisateur est connecté : true ou false
                        auth()->user()  => nous renvoie les informations de l'utilisateur connecté sinon NULL
                        auth()->id()    => nous renvoie l'id' de l'utilisateur connecté sinon NULL
                        --}}
